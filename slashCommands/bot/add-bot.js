 ...
 const modalAddbot = new ModalBuilder()
  ...
  const prefixInput = new TextInputBuilder()
   ...
   .setPlaceholder('Ej: 0123456789101112')
    ...
    try {
    await interaction.reply({ content: '<:tick_very:886814313493430303> Tu bot ha sido agregado, espera pacientemente la revisión de los testers. (Habilitá tu dm para que te mande un mensaje)', ephemeral: false });
     } catch(err) {}
